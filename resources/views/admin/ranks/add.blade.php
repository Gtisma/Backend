...
@section('content')
    ...
    <section class="r-split-twin_content r-gutter--bottom r-d-flex r-flex-dir-col r-al-i-l r-tx-l r-gutter--2x@lg r-edges">
        ...
        <h2 class="r-sr">Add Rank</h2>


        <div class="r-w-100% r-maxwidth-xs">
            <h3 class="r-mt-0 r-headline--small">Add New Rank</h3>

            <div class="r-tx-l">
                <form method="POST" action="{{ route('admin.store.rank') }}" id="rankform" >
                    @csrf

                    <p class="r-select-wrapper r-mb-0">
                        <label for="security_id">Select Security Outfit for Rank</label>
                        <select name="security_id" id ="securities"  class="browser-default">
                    ...
                    <div class="input-field r-d-flex">
                        <p class="input-field r-mb-0 r-w-100%" >
                            <input id="rank_name" type="text" name="rank_name" placeholder="Constable" autocomplete="rank_name" required>
                            <label for="rank_name" class="">Rank name</label>
                        </p>
                    </div>
                    ...
                    <button  type="submit" class="r-btn r-btn--primary r-btn--match-input r-btn--left-floated-icon input-field r-btn-spinner">
                        ...
                        <span class="r-fw-medium r-btn_text"> {{ __('Add Ranks') }}</span>
