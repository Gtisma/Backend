<nav class="r-aside_inner r-gutter r-edges--left">
    ...
    <ul class="r-none r-list"><li class="r-no-border r-mb-h">
            <a class="is-active r-list-item is-vertical-nav" href="https://adx-usr.now.sh/"><svg width="30" height="30" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-labelledby="homeAlt2IconTitle" stroke="#52154e" stroke-width="1.875" stroke-linecap="round" stroke-linejoin="miter" fill="none" color="#52154e" class="icon icon-home">
            ...
            <a class=" r-list-item is-vertical-nav" href="https://adx-usr.now.sh/loans/"><svg width="30" height="30" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-labelledby="supportIconTitle" stroke="#52154e" stroke-width="1.875" stroke-linecap="round" stroke-linejoin="miter" fill="none" color="#52154e" class="icon icon-support">
