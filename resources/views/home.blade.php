...
<head>
    ...
    <!--====== Line Icons CSS ======-->
    <link rel="stylesheet" href="{{ asset('homeassets/css/LineIcons.2.0.css')}}">

    <!--====== Bootstrap CSS ======-->
    <link rel="stylesheet" href="{{ asset('homeassets/css/bootstrap-4.5.0.min.css')}}">
...
{{--                                </li>--}}
    ...
    <div id="home" class="header-hero bg_cover" style="background-image: url({{ asset('homeassets/images/banner-bg.svg')}})">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="header-hero-image text-center wow fadeIn" data-wow-duration="1.3s" data-wow-delay="1.4s">
                        <img src="{{ asset('homeassets/images/header-img.png')}}" alt="hero">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="about-image text-center mt-50 wow fadeInRightBig" data-wow-duration="1s" data-wow-delay="0.5s">
                    <img src="{{ asset('homeassets/images/about1.svg')}}" alt="about">
                </div> <!-- about image -->
            </div>
        </div> <!-- row -->
    </div> <!-- container -->
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="video-content mt-50 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                    <img class="dots" src="{{ asset('homeassets/images/dots.svg')}}" alt="dots">
                    <div class="video-wrapper">
                        <div class="video-image">

                            <img src="{{ asset('homeassets/images/video.png')}}" alt="video">
                        </div>
...
<script src="{{ asset('homeassets/js/bootstrap-4.5.0.min.js') }}"></script>
...
<script src="{{ asset('homeassets/js/scrolling-nav.js') }}"></script>

<!--====== wow js ======-->
<script src="{{ asset('homeassets/js/wow.min.js') }}"></script>

<!--====== Particles js ======-->
<script src="{{ asset('homeassets/js/particles.min.js') }}"></script>
